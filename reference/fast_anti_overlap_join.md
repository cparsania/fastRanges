...
- query_prefix:
  ...
  Prefix applied to query columns.
...
`overlap_count` is always `0` in the returned table and is included to
keep the result grammar parallel to
...
#> [1] query_id      overlap_count query_start   query_end     query_width  
