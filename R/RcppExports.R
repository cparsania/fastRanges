...
cpp_find_overlaps_indexed <- function(q_start, q_end, q_seq, q_strand, s_start, s_end, s_seq, s_strand, s_original, partition_keys, partition_starts, partition_ends, max_gap, min_overlap, type, ignore_strand, threads, deterministic) {
